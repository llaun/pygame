...
def initGame():
    ...
    aircraft = pygame.image.load("pygame_sample/image/images/plane 복사본.png")
    background1 = pygame.image.load("pygame_sample/image/images/background.png")
    background2 = background1.copy()
    bat = pygame.image.load("pygame_sample/image/images/bat.png")
    fires.append(pygame.image.load("pygame_sample/image/images/fireball.png"))
    fires.append(pygame.image.load("pygame_sample/image/images/fireball2.png"))


    # ---------------->ADDED
    boom = pygame.image.load("pygame_sample/image/images/boom.png")
    # ---------------->

    for i in range(5):
        fires.append(None)

    bullet= pygame.image.load("pygame_sample/image/images/bullet.png")
